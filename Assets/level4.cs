...
public class level4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log(m_fb.lv4bullets);
        if(countdown.seconds == 0)
        {
        if(m_fb.toonkilled >= 14)
        {
...
Debug.Log("Level completed");
            ...
            else if(m_fb.lv4bullets<=0 && m_fb.toonkilled != 14)
            {
                 Debug.Log("Game over");
        ...
        if(totalbullets != m_fb.lv4bullets)
        {
          float n =  totalbullets - m_fb.lv4bullets;
          for(int i = 0 ;i < n ;i++)
          {
